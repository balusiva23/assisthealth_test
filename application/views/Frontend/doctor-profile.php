...
<!-- Mirrored from world5.commonsupport.com/html/medi-plus/doctor-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jun 2023 13:36:28 GMT -->
<head>
	<meta charset="UTF-8">
...
<body>
	...
	<section class="sec-padding doctor-profile">
		<div class="container">
			<div class="row">
				<div class="col-md-5">
					<img src="img/team/single-doctor.jpg" alt="">
				</div>
				<div class="col-md-7 single-team-member">
					...
					<ul class="infos">
						<li><span>Speciality</span> <span>&nbsp;&nbsp;Physiotherapist</span></li>
						<li><span>Degrees</span> <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M.D. of Medicine</span></li>
	...
	<section class="home-appointment-form doctor-profile">
		<div class="container">
			<hr>
			<div class="heading">
				<h3>Make an Appoinment With Dr. Rashed kabir ? <br> Book Now!!</h3>
			</div>
	...
	<section class="footer-call-to-action">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="http://themeforest.net/item/medi-plus-health-and-medical-html-template/15017162" target="_blank" class="thm-btn inverse pull-right">Purchase Now</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="footer-widget contact-widget">
						...
						<form action="http://world5.commonsupport.com/html/medi-plus/inc/sendemail.php" class="contact-form" id="footer-cf">
