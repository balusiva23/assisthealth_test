                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box  mt-10">
                                <div class="card-head center">
                                    ...
                                    <h2>Your Navigator</h2>

                                </div>
                                <div class="card-body" id="bar-parent">
                                    <?php if(isset($navigator_data->profile_picture) || isset($navigator_data->name) || isset($navigator_data->mobile_no)) { ?>
                                    <div class="doctor-profile">
                                        <img src="<?php if(isset($navigator_data->profile_picture)) { echo base_url('assets/uploads/manager_profile/').$navigator_data->profile_picture; }else{echo base_url('/assets/default.png'); }?>" class="doctor-pic" alt="">
                                        ...
                                        $values = explode(",", $navigator_data->language_spoken);
                                         ...
                                         <div style="    width: 50%; margin: 0 auto;"> 
                                             ...
                                             <p><span  style="font-weight:bold" > Intro about Navigator :</span> <?php echo $navigator_data->intro; ?></p>
                                         <?php } ?>
                                         </div>
