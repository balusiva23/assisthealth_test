                            ...
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Previous Medical Conditions (If applicable) :</header>
                                        <input type="checkbox" name="table1_checkbox" value="1">
                         ...
                         <div class="col-md-6 col-sm-6">
                            <div class="card card-box">
                                <div class="card-head">
                                  ...
                                  <input type="checkbox" name="table2_checkbox" value="1">
                                </div>
                ...
                <div class="col-md-6 col-sm-6">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <div class="card-body " id="bar-parent5">
                                   <button type="submit"  class="btn btn-primary" id="add_medical">Generate PDF</button>

                   <!--  <form   action="<?= base_url('Admin/generate_pdf') ?>" method="post">
                                                       <input type="hidden" name="table1_checkbox" value="0">
                            <input type="hidden" name="table2_checkbox"  value="0">
