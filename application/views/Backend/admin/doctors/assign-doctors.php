                                                                 ...
                                                                 <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                   ...
                                                                   <td class="center">    <?php if(isset($doctorbyid->name)){ echo $doctorbyid->name; } ?></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn blue-bgcolor btn-outline btn-circle m-b-10" data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Admin/Subprofile_Assign_Doctors?id=<?= 
                                                                        $member->id?>">
...
<script type="text/javascript">
 ...
 $(document).on('click','#update_member',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Admin/Add_Assign_Doctors");?>',
