<table class="center-container" border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-right: 5%; background-image: url('<?php echo base_url("assets/backend_assets/img/id/id-bg1.png"); ?>'); background-size: 100% 100%; background-repeat: no-repeat; width: 530px; height: 300px;">
		    <tr>
		    <br>
		    <td style="width: 48%; "><p style="font-weight: bold; color: #38B6FF; font-size: 15px;">
		        <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="background-color: ; border-radius: 10px;  margin-left: 10px; width:10%"><span style="color:#38B6FF;text-transform: uppercase;"><?php echo insertBrAfterThreeWords($m_name); ?></span></span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: black;background-color: ;border-radius: 10px;  ">ASSISTHEALTH ID:&nbsp;&nbsp;<span style="color: #aa893f;background-color: ;"><?php echo $m_id ?></span></span> </p>
...
<?php function insertBrAfterThreeWords($inputString) {
