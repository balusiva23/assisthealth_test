                    ...
                    <div class="state-overview">
                        <div class="row">
                             ...
                             <div class="col-xl-3 col-md-6 col-12">
                                  <a href="<?php echo base_url(); ?>Navigator/My_Members" style="color: white;">
                                <div class="info-box bg-info">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $this->db->where(array('navigator'=>$id,'isActive'=>1))->count_all_results('members'); ?></span>
                            ...
                            <?php
                            //ALl
                            $allsql = "SELECT * FROM members JOIN appointment ON members.id = appointment.mid WHERE members.navigator = ?  AND appointment.isActive = 1 AND members.isActive = 1  AND appointment.appointment_status != ''";
                            $allquery = $this->db->query($allsql, array($id));
                            $allresult = $allquery->num_rows();   
                           //ongoing
                            $ongoingsql = "SELECT * FROM members JOIN appointment ON members.id = appointment.mid WHERE members.navigator = ?   AND appointment.appointment_status = 'Ongoing' AND appointment.isActive = 1 AND members.isActive = 1";
                            $ongoingquery = $this->db->query($ongoingsql, array($id));
                            $ongoingresult = $ongoingquery->num_rows();   
                            //completed
                            $completedsql = "SELECT * FROM members JOIN appointment ON members.id = appointment.mid WHERE members.navigator = ?   AND appointment.appointment_status = 'Completed' AND appointment.isActive = 1 AND members.isActive = 1";
                            $completedquery = $this->db->query($completedsql, array($id));
                            $completedresult = $completedquery->num_rows(); 
                             //Pending
                            $pendingsql = "SELECT * FROM members JOIN appointment ON members.id = appointment.mid WHERE members.navigator = ?   AND appointment.appointment_status = 'Pending' AND appointment.isActive = 1 AND members.isActive = 1";
                           ...
                           //New Member count
                             ...
                             ?>
                                <div class="col-xl-3 col-md-6 col-12">
                                    <a href="<?php echo base_url(); ?>Navigator/All_Doctors" style="color: white;">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                 <a href="<?php echo base_url(); ?>Navigator/View_members" style="color: white;">
                            ...
                            <!-- /.col -->
                                   <div class="col-xl-3 col-md-6 col-12">
                                     <a href="<?php echo base_url(); ?>Navigator/Pending_Appointment" style="color: white;">
                              ...
                              <!-- /.col -->  
                             <div class="col-xl-3 col-md-6 col-12">
                                 <a href="<?php echo base_url(); ?>Navigator/Ongoing_Appointment" style="color: white;">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                 <a href="<?php echo base_url(); ?>Navigator/Completed_Appointment" style="color: white;">
                                ...
                                <div class="info-box deepPink-bgcolor">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $this->db->where(array('navigator'=>$id,'isActive'=>1,'navigator_status'=>1))->count_all_results('members'); ?></span>
                                ...
                                <div class="info-box yellow-bgcolor" style="background-color: #20c997;">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo $this->db->where(array('navigator'=>$id,'isActive'=>1,'isSubprofile ='=>'Yes'))->count_all_results('members'); ?></span>
...
//calender
 ...
 //var today = new Date('2022-11-2');
  ...
  var calendar = $('#calendar').fullCalendar({
   ...
   events: '<?php echo base_url(); ?>Navigator/load',
