    ...
    <div class="page-wrapper">
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title"> Assign  Doctors</div>
                            </div>
                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center">Navigator
                                                                    <th class="center">Doctor
                                                                    </th>
                                                                 ...
                                                                 <tr class="odd gradeX" data-id="<?=$member->id;?>">
                                                                   ...
                                                                   <td class="center">    <?php if(isset($doctorbyid->name)){ echo $doctorbyid->name; } ?></td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a class="btn blue-bgcolor btn-outline btn-circle m-b-10" data-id="<?php echo $member->id; ?>" href="<?php echo base_url(); ?>Navigator/Subprofile_Assign_Doctors?id=<?= 
                                                                        $member->id?>">
        ...
        <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Assign Doctors</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="#" id="member_form_add" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-md-4">Assign Doctors
                                        <span class="required"> * </span>
                                    </label>
                                    <div class="col-md-8">
                                        <select class="form-control input-height" name="doctor" id="navigator">
                                            <option value="">Select...</option>
                                           <?php 
                                             foreach ($doctors as  $value) { ?>
                                                 <option value="<?= $value->id ?>"><?= $value->name.' ('.$this->db->where(array('doctor'=>$value->id,'isActive'=>1))->count_all_results('members').')'; ?></option>
                                           <?php  }
                                           ?>
                                        </select>
                                    </div>
...
<script type="text/javascript">
      ...
      //  $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                ...
                $('#staticBackdrop [name="id"]').val(response.id);
                    ...
                    $('#staticBackdrop [name="doctor"]').val(response.doctor);
                    $('#staticBackdrop [name="member_id"]').val(response.member_id);
                      // new sub profile
 ...
 $(document).on('click','#update_member',function(){
        ...
        $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/Add_Assign_Doctors");?>',
       ...
       // console.log(data.member)
        ...
        // rowToUpdate.find(".center:eq(4)").text(data.member.manager_name);
         rowToUpdate.find(".center:eq(5)").text(data.member.manager_name);
