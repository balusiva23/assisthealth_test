                                                        ...
                                                        <table
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="center"> Medical Council No </th>

                                                                    <th class="center"> Intro about Doctor</th>
                                                ...
                                                ?>
                                                        <tr class="odd gradeX" data-id="<?=$navigator->id;?>">
                                                            ...
                                                            <td class="center"><?php echo $navigator->language_spoken; ?></td>
                                                                 <td class="center"><?php echo $navigator->qualification; ?></td>
                                                            <td class="center"><?php echo $navigator->medical_council_no; ?></td>
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <td class="center"><?php echo $this->db->where(array('doctor'=>$navigator->id,'isActive'=>1))->count_all_results('members'); ?></td>
                                                            <td class="center">
...
<script>
    $(document).ready(function() {
       ...
       // $('.tblEditBtn').click(function() {
            ...
            $.ajax({
                url: '<?php echo base_url("Navigator/getDoctorByID"); ?>?id=' + id,
                method: 'GET',
                data: { id: id },
                dataType: 'json',
                success: function(response) {
                    ...
                    $('#staticBackdrop [name="medical_council_no"]').val(response.medical_council_no);
        ...
        event.preventDefault();
         ...
         $.ajax({
        type:'post',
        url: '<?php echo base_url("Navigator/Update_doctor");?>',
       ...
       rowToUpdate.find(".center:eq(1)").text(data.member.name);
        ...
        rowToUpdate.find(".center:eq(6)").text(data.member.qualification);
        rowToUpdate.find(".center:eq(7)").text(data.member.medical_council_no);
         rowToUpdate.find(".center:eq(8) .intro-short").text(data.member.intro);
   ...
   $.confirm({
    ...
    $.ajax({
    type: 'post',
    url: '<?php echo base_url('Navigator/Doctordelete') ?>',
    data: {id:id},
    success: function (response) {
